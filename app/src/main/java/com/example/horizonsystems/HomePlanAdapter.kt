...
class HomePlanAdapter(
    ...
    class HomePlanViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomePlanViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_home_plan, parent, false)
        return HomePlanViewHolder(view)
    }

    override fun onBindViewHolder(holder: HomePlanViewHolder, position: Int) {
        ...
        holder.tvHomePlanDesc.text = plan.description ?: "Explore our premium amenities."
