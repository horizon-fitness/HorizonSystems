...
data class RegisterRequest(
    ...
    @SerializedName("weekly_commitment") val weeklyCommitment: String? = null,
    @SerializedName("target_weight") val targetWeight: Double? = null,
    @SerializedName("equipment_availability") val equipmentAvailability: String? = null,
    @SerializedName("injuries_limitations") val injuriesLimitations: String? = null,
